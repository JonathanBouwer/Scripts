...
for %%f in (*.mkv) do ffmpeg -i "%%f" -map 0:v:0 -map 0:a:1 -map 0:a:0 -map 0:s:1 -map 0:s:0 -c copy -disposition:a:0 default -disposition:a:1 none -disposition:s:0 default -disposition:s:1 none "output/%%f"